...
sha512sums=('73724a920032cf75c75ea739403a7ce150101867fd0c408c48755773d0ee9d0d8b268ce388b6bcb67f7e117f4f37b136ff5d39e001a57d8476c1e41211fb8e24'
            ...
            'f7964e3eb0c8249074f21a96fc2b8d92f0afa6b9c1a2aea85910863bffb2dd546acbbc6faf4e9f92f639ea52c619986d9d55ab90719bb7f9389f17e9e0ef5d4c')

prepare() {
	cd "${pkgname}"
	patch -Np1 -i "${srcdir}/skip-failing-test.patch"
	patch -Np1 -i "${srcdir}/jenkins-sysusers.patch"
}
